...
<button type="button" class="btn btn-primary add" data-toggle="modal" data-target="#AddCity" style="float: right;">Add</button> <br><br>
<!-- Modal -->
        ...
        <form method="post" enctype="multipart/form-data" >
            @csrf
                <div class="form-group">
                    ...
                    <span class="error" id="cat_error" style="display:none">City Name  is Required!</span>
                </div><br>
                <div class="form-group">
                        <label>Icon</label>
                ...
                <div class="text-right">
                    ...
                    <button type="button" class="btn btn-primary"  style="height:37px" id="addcity">Save changes</button>
                    <button type="button" class="btn btn-primary"  style="height:37px;display:none" id="editcity">update changes</button>
                </div><br>
        </form>
      </div>
    </div>
